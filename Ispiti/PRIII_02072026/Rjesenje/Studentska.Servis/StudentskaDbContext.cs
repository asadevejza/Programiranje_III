...
namespace Studentska.Servis
{
    public class StudentskaDbContext : DbContext
    {
        ...
        public DbSet<StatusIB230XXX> StatusIB230XXX { get; set; }
        public DbSet<ProjektiIB230XXX> ProjektiIB230XXX { get; set; }
        public DbSet<StudentiProjektiIB230XXX> StudentiProjektiIB230XXX { get; set; }
